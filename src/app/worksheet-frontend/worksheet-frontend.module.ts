...
@NgModule({
  declarations: [WorksheetFrontendComponent, MainComponent, DashboardComponent, ChangePasswordComponent, TopicComponent, SubtopicComponent, LoginComponent, UpdateDetailsComponent],
  imports: [
    CommonModule,
