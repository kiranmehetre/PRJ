...
@Component({
  ...
  styleUrls: ['./std01-singular-plural-nouns-worksheet2.component.scss']
})
    ...
    $(document).ready(function(){
			...
			$('.helpbox').click(function(){
                if(inputField !== undefined){
					...
					var QuestionText=$(inputField).attr('data-text');
					if(HelpBoxText=="ies")
					{
						var QuestionTextLength=QuestionText.length;
						var CheckText=QuestionText.substr(0, QuestionTextLength-1);
						HelpBoxText=CheckText+HelpBoxText;
					}
					else
					{
						HelpBoxText=QuestionText+HelpBoxText;
					}
			...
			$('.button').click(function(){
				...
				else
				{
					...
					if(inputCount >= 5){
						$(inputs).removeClass('bd');
						var Correct_Answers=["cities","monkeys","berries","skies","trays","daisies","nappies","days","parties","keys"];
