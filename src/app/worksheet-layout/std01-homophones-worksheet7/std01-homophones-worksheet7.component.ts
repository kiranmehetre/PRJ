...
@Component({
  selector: 'app-std01-homophones-worksheet7',
  templateUrl: './std01-homophones-worksheet7.component.html',
  styleUrls: ['./std01-homophones-worksheet7.component.scss']
})
export class Std01HomophonesWorksheet7Component implements OnInit {
  ...
  ngOnInit() {
    ...
    $('.button').click(function () {
      ...
      if ($('.button').hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
          $(inputs).parent().removeClass('bd');
          var Correct_Answers = ["hour", "flour", "blue", "bye", "whole", "won", "read", "through"];
