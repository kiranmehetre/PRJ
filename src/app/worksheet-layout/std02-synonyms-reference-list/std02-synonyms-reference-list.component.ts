...
@Component({
  selector: 'app-std02-synonyms-reference-list',
  templateUrl: './std02-synonyms-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std02-synonyms-reference-list.component.scss']
})
export class Std02SynonymsReferenceListComponent implements OnInit {
