...
@Component({
  selector: 'app-std02-mixed-verb-worksheet5',
  templateUrl: './std02-mixed-verb-worksheet5.component.html',
  styleUrls: ['./std02-mixed-verb-worksheet5.component.scss']
})
export class Std02MixedVerbWorksheet5Component implements OnInit {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
          globalThis.commonWorksheet.reloadComponent();
            ...
            if (inputCount >= 4) {
                $('input').removeClass('bd');
                var Correct_Answers = ["was", "began", "would", "buy", "will", "go","speak","fell"];
