...
@Component({
  selector: 'app-std02-homophones-reference-list',
  templateUrl: './std02-homophones-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std02-homophones-reference-list.component.scss']
})
export class Std02HomophonesReferenceListComponent implements OnInit {
