...
@Component({
  ...
  templateUrl: './std02-singular-plural-nouns-worksheet6.component.html',
  styleUrls: ['./std02-singular-plural-nouns-worksheet6.component.scss']
})
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 6) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["calves", "lorries", "knives", "babies", "elves", "families", "leaves", "stories", "shelves", "cities", "lives", "ladies"];
