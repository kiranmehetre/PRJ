...
@Component({
  selector: 'app-std01-collective-noun-worksheet9',
  templateUrl: './std01-collective-noun-worksheet9.component.html',
  styleUrls: ['./std01-collective-noun-worksheet9.component.scss']
})
export class Std01CollectiveNounWorksheet9Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($(this).hasClass('playAgain')) {
          ...
          if ($('.click').length >= 3) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["stamps", "books", "people", "ducks", "rabbits", "deer"];
