...
@Component({
  selector: 'app-std03-action-verb-worksheet2',
  templateUrl: './std03-action-verb-worksheet2.component.html',
  styleUrls: ['./std03-action-verb-worksheet2.component.scss']
})
export class Std03ActionVerbWorksheet2Component implements OnInit {
    ...
    $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
            ...
            if (inputCount >= 5) {
                ...
                var Correct_Answers = ["crawl", "skid", "bounce", "imagine", "scream", "munch", "instruct", "graze", "squeeze", "sprinkle"];
