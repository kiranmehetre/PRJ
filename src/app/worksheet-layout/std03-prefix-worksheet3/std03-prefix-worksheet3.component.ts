...
@Component({
  selector: 'app-std03-prefix-worksheet3',
  templateUrl: './std03-prefix-worksheet3.component.html',
  styleUrls: ['./std03-prefix-worksheet3.component.scss']
})
export class Std03PrefixWorksheet3Component implements OnInit {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
            ...
            if (inputCount >= 4) {
                ...
                var Correct_Answers = ["unable", "misspell", "disloyal", "rename", "unknown", "pretest", "inactive", "improper"];
