...
@Component({
  selector: 'app-std01-rhyming-words-worksheet8',
  templateUrl: './std01-rhyming-words-worksheet8.component.html',
  styleUrls: ['./std01-rhyming-words-worksheet8.component.scss']
})
export class Std01RhymingWordsWorksheet8Component implements OnInit {
      ...
      $('.button').click(function () {
        if ($(this).hasClass('playAgain')) {
          ...
          if (inputCount >= 6) {
            ...
            var Correct_Answers = [["fan", "pan"], ["spoon", "balloon"], ["cook", "hook"], ["pin", "thin"], ["sheep", "weep"], ["car", "jar"]];

            $('.Main_Row').each(function (i) {
              var inputRowValues = [];
              var Wrong_Answers = [];
