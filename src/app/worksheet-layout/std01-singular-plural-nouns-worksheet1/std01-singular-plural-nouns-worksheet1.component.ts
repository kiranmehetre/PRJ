...
@Component({
  selector: 'app-std01-singular-plural-nouns-worksheet1',
  templateUrl: './std01-singular-plural-nouns-worksheet1.component.html',
  styleUrls: ['./std01-singular-plural-nouns-worksheet1.component.scss']
})
export class Std01SingularPluralNounsWorksheet1Component implements OnInit {
    ...
    $(document).ready(function(){
			...
			$('.button').click(function(){
				if($(this).hasClass('playAgain')){
					...
					if(inputCount >= 6){
						$(inputs).removeClass('bd');
						var SingularInputs=$('.singular input');
						var PluralInputs=$('.plural input');
						var inputArray=[SingularInputs,PluralInputs];
						var Correct_Answers=[];
						Correct_Answers[0]=["cousin","shirt","tree","buffalo","pond","story"];
						Correct_Answers[1]=["birds","fairies","leaves","pictures","flowers","elves"];
