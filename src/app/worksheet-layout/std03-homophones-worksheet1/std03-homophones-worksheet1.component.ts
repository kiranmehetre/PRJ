...
@Component({
  selector: 'app-std03-homophones-worksheet1',
  templateUrl: './std03-homophones-worksheet1.component.html',
  styleUrls: ['./std03-homophones-worksheet1.component.scss']
})
export class Std03HomophonesWorksheet1Component implements OnInit {
