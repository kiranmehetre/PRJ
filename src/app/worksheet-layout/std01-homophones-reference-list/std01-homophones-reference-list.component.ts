...
@Component({
  selector: 'app-std01-homophones-reference-list',
  templateUrl: './std01-homophones-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std01-homophones-reference-list.component.scss']
})
export class Std01HomophonesReferenceListComponent implements OnInit {
