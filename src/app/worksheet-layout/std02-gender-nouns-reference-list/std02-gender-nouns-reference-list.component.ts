...
@Component({
  selector: 'app-std02-gender-nouns-reference-list',
  templateUrl: './std02-gender-nouns-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std02-gender-nouns-reference-list.component.scss']
})
export class Std02GenderNounsReferenceListComponent implements OnInit {
