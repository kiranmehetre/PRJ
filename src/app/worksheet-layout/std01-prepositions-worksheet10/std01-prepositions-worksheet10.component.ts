...
@Component({
  selector: 'app-std01-prepositions-worksheet10',
  templateUrl: './std01-prepositions-worksheet10.component.html',
  styleUrls: ['./std01-prepositions-worksheet10.component.scss']
})
export class Std01PrepositionsWorksheet10Component implements OnInit {
...
$('.button').click(function () {
  //  debugger;
    if ($('.button').hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
            $(inputs).parent().removeClass('bd');
            var Correct_Answers = ["in", "for", "on", "beside", "under", "to", "at", "next to"];
