...
@Component({
  selector: 'app-std02-action-verbs-worksheet5',
  templateUrl: './std02-action-verbs-worksheet5.component.html',
  styleUrls: ['./std02-action-verbs-worksheet5.component.scss']
})
export class Std02ActionVerbsWorksheet5Component implements OnInit {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
          globalThis.commonWorksheet.reloadComponent();
            ...
            if (inputCount >= 4) {
                $('input').removeClass('bd');
                var Correct_Answers = ["behave", "drank", "found", "carried", "glued", "fly","laughed","mix"];
