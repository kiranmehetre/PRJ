...
@Component({
  ...
  templateUrl: './std03-apostrophe-worksheet2.component.html',
  styleUrls: ['./std03-apostrophe-worksheet2.component.scss']
})
 ...
 this.commonWorksheet.reuseRoute();
    ...
    $(document).ready(function () {
        ...
        $(inputs).click(function () {
            inputField = $(this);
            inputNumber = $(this).parent().siblings('.number-box').text().trim();
            ...
            $(".option-container span").filter(function () {
        ...
        $('.button').click(function () {
            ...
            if ($('.button').hasClass('playAgain')) {
                ...
                if (inputCount >= 4) {
                    $(inputs).removeClass('bd');
                    var Correct_Answers = ["chair’s", "Bruce’s", "artists’", "tree’s", "animals’", "neighbour’s", "women’s", "book’s"];
                    ...
                    $('input,.option-container span').css('pointer-events', 'none');
                }
                else {
                    setTimeout(function () {
                        $('.result').css('display', 'flex');
