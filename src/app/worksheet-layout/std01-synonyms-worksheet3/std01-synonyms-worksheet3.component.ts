...
@Component({
  selector: 'app-std01-synonyms-worksheet3',
  templateUrl: './std01-synonyms-worksheet3.component.html',
  styleUrls: ['./std01-synonyms-worksheet3.component.scss']
})
export class Std01SynonymsWorksheet3Component implements OnInit {
  ...
  $('.button').click(function(){
    if($(this).hasClass('playAgain')){
     globalThis.commonWorksheet.reloadComponent();
      ...
      if(inputCount >= 4){
        $(inputs).removeClass('bd');
        var Correct_Answers=["C","F","D","H","A","E","B","G"];
