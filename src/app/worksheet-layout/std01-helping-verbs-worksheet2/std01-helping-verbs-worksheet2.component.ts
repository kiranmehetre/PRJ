...
@Component({
  selector: 'app-std01-helping-verbs-worksheet2',
  templateUrl: './std01-helping-verbs-worksheet2.component.html',
  styleUrls: ['./std01-helping-verbs-worksheet2.component.scss']
})
export class Std01HelpingVerbsWorksheet2Component implements OnInit {
    ...
    $(document).ready(function(){
      ...
      $('.button').click(function(){
        ...
        else
        {
          ...
          if(inputCount >= 4){
            $(inputs).removeClass('bd');
            var Correct_Answers=["are","is","are","am","is","are","am","are"];
