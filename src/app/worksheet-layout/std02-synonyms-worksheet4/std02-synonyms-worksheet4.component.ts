...
@Component({
  selector: 'app-std02-synonyms-worksheet4',
  templateUrl: './std02-synonyms-worksheet4.component.html',
  styleUrls: ['./std02-synonyms-worksheet4.component.scss']
})
export class Std02SynonymsWorksheet4Component implements OnInit {
...
$(document).ready(function () {
  ...
  $('.button').click(function () {
      ...
      if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 4) {
              $(inputs).removeClass('bd');
              var Correct_Answers = ["F", "A", "H", "D", "G", "C", "E", "B"];
