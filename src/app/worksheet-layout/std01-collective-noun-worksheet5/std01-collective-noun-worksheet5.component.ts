...
@Component({
  selector: 'app-std01-collective-noun-worksheet5',
  templateUrl: './std01-collective-noun-worksheet5.component.html',
  styleUrls: ['./std01-collective-noun-worksheet5.component.scss']
})
export class Std01CollectiveNounWorksheet5Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    $('input').on('click', function () {
      ...
      $(".helpbox-ans div").filter(function () {
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 3) {
          ...
          var Correct_Answers = ["ants", "flowers", "books", "puppies", "grapes", "bananas"];
