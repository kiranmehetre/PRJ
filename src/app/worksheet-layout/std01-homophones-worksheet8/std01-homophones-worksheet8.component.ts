...
@Component({
  selector: 'app-std01-homophones-worksheet8',
  templateUrl: './std01-homophones-worksheet8.component.html',
  styleUrls: ['./std01-homophones-worksheet8.component.scss']
})
export class Std01HomophonesWorksheet8Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
          $(inputs).removeClass('bd');
          var Correct_Answers = ["mail", "role", "know", "meet", "foul", "pear", "pale", "tale"];
