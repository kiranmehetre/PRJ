...
@Component({
  selector: 'app-std01-compound-word-worksheet7',
  templateUrl: './std01-compound-word-worksheet7.component.html',
  styleUrls: ['./std01-compound-word-worksheet7.component.scss']
})
export class Std01CompoundWordWorksheet7Component implements OnInit {
    ...
    var theToggle = document.getElementById('toggle');
      ...
      theToggle.onclick = function() {
        ...
        $('.button').click(function(){
          ...
          {
            var Correct_Answers_Count=0;
            var inputCount=$('.first-shape span').filter(function () {
                      return !!$(this).text();
                    }).length;
            if(inputCount >= 5){
              $(inputs).removeClass('bd');
              var Correct_Answers=["neck","bed","police","shoe","skate","lip","hair","night","class","book"];
