...
@Component({
  selector: 'app-std03-compound-word-worksheet2',
  templateUrl: './std03-compound-word-worksheet2.component.html',
  styleUrls: ['./std03-compound-word-worksheet2.component.scss']
})
export class Std03CompoundWordWorksheet2Component implements OnInit {
