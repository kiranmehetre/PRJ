...
@Component({
  selector: 'app-std02-homophones-worksheet5',
  templateUrl: './std02-homophones-worksheet5.component.html',
  styleUrls: ['./std02-homophones-worksheet5.component.scss']
})
export class Std02HomophonesWorksheet5Component implements OnInit {
    ...
    $(document).ready(function(){
			...
			$('.button').click(function(){
				...
				else
				{
					...
					if(inputCount >= 6){
						$(inputs).removeClass('bd');
						var Correct_Answers=["ate","red","sun","two","eye","no","see","tail","deer","hair","male","blue"];
