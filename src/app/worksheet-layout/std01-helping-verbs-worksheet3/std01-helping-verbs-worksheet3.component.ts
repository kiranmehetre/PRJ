...
@Component({
  selector: 'app-std01-helping-verbs-worksheet3',
  templateUrl: './std01-helping-verbs-worksheet3.component.html',
  styleUrls: ['./std01-helping-verbs-worksheet3.component.scss']
})
export class Std01HelpingVerbsWorksheet3Component implements OnInit {
    ...
    $(document).ready(function(){
      ...
      $('.button').click(function(){
        ...
        else
        {
          ...
          if(inputCount >= 6){
            $(inputs).removeClass('bd');
            var Correct_Answers=["was","were","was","was","were","was","was","were","were","were","was","were"];
