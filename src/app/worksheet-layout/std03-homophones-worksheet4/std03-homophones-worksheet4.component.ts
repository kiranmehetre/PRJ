...
@Component({
  selector: 'app-std03-homophones-worksheet4',
  templateUrl: './std03-homophones-worksheet4.component.html',
  styleUrls: ['./std03-homophones-worksheet4.component.scss']
})
export class Std03HomophonesWorksheet4Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 5) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["creek", "fir", "meet", "pale", "cue", "piece", "wail", "steak", "vane", "route"];
