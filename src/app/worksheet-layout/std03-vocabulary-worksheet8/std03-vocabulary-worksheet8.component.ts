...
@Component({
  selector: 'app-std03-vocabulary-worksheet8',
  templateUrl: './std03-vocabulary-worksheet8.component.html',
  styleUrls: ['./std03-vocabulary-worksheet8.component.scss']
})
export class Std03VocabularyWorksheet8Component implements OnInit {
