...
@Component({
  selector: 'app-std03-gender-nouns-worksheet9',
  templateUrl: './std03-gender-nouns-worksheet9.component.html',
  styleUrls: ['./std03-gender-nouns-worksheet9.component.scss']
})
export class Std03GenderNounsWorksheet9Component implements OnInit {
