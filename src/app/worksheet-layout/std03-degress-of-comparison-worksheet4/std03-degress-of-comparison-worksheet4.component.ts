...
@Component({
  selector: 'app-std03-degress-of-comparison-worksheet4',
  templateUrl: './std03-degress-of-comparison-worksheet4.component.html',
  styleUrls: ['./std03-degress-of-comparison-worksheet4.component.scss']
})
export class Std03DegressOfComparisonWorksheet4Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 6) {
          $('input').removeClass('bd');
          var Correct_Answers = ["braver", "more", "more expensive", "brighter", "tinier", "more wonderful", "bravest", "most", "most expensive", "brightest", "tiniest", "most wonderful"];
