...
@Component({
  selector: 'app-std03-articles-worksheet5',
  templateUrl: './std03-articles-worksheet5.component.html',
  styleUrls: ['./std03-articles-worksheet5.component.scss']
})
export class Std03ArticlesWorksheet5Component implements OnInit {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if ($('.underlined').length >= 5) {
            ...
            $('.option.right').addClass('colorgreen');
