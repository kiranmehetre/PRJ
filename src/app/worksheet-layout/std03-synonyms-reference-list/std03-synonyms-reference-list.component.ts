...
@Component({
  selector: 'app-std03-synonyms-reference-list',
  templateUrl: './std03-synonyms-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std03-synonyms-reference-list.component.scss']
})
export class Std03SynonymsReferenceListComponent implements OnInit {
