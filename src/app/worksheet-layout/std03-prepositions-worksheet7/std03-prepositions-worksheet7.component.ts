...
@Component({
  selector: 'app-std03-prepositions-worksheet7',
  templateUrl: './std03-prepositions-worksheet7.component.html',
  styleUrls: ['./std03-prepositions-worksheet7.component.scss']
})
export class Std03PrepositionsWorksheet7Component implements OnInit {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if ($('.click').length >= 3) {
            ...
            setTimeout(function () {
              $('.result').css('display', 'flex');
              $('.result .TextBox h1').text('Please colour at least 3 circles before submitting');
            }, 500);
          }
        }
      });
