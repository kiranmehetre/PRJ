...
@Component({
  selector: 'app-std03-homophones-worksheet10',
  templateUrl: './std03-homophones-worksheet10.component.html',
  styleUrls: ['./std03-homophones-worksheet10.component.scss']
})
export class Std03HomophonesWorksheet10Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($(this).hasClass('playAgain')) {
          ...
          if (inputCount >= 5) {
            $(inputs).removeClass('bd');
            var Correct_Answers = [["allowed", "aloud"], ["seller", "celler"], ["eye", "I"], ["currents", "currants"], ["no", "know"], ["our", "hour"], ["knight", "night"], ["heel", "heal"], ["not", "knot"], ["read", "Red"]];

            $('.Question_Row').each(function (i) {
              var isTrue = true;
              var QuestionInputs = $(this).find('input');
              $(QuestionInputs).each(function (x) {
