...
@Component({
  ...
  styleUrls: ['./std01-comprehensions-worksheet3.component.scss']
})
...
$(document).ready(function(){
  var BackgroundImagesLandscapeArr=["url(/assets/std01-comprehensions-worksheet3/img/slide1_bg.jpg)","url(/assets/std01-comprehensions-worksheet3/img/slide2_bg.jpg)"];
  var BackgroundImagesPortraitArr=["url(/assets/std01-comprehensions-worksheet3/img/slide1_bg_portrait.jpg)","url(/assets/std01-comprehensions-worksheet3/img/slide2_bg_portrait.jpg)"];
...
$(".question.one .option,.second .helpbox-container .col-12 div").filter(function() {
return $(this).text().trim() === inputValue;
}).removeClass('click');
$(this).val("");
      inputNumber=$(this).closest('.question').find('.number').text().trim();
  });
$('.question.one .option,.second .helpbox-container .col-12 div').click(function(){
...
$('.question.six input').each(function(i){
  if($.trim($(this).val().toString()) !== Correct_Answers[i]){
    ...
    $(this).closest('.row').find('.answer').addClass('inlineBlock');
  }
});
...
$('input,.option,.option-question,.second .helpbox-container .col-12 div').css('pointer-events','none');
          setTimeout(function(){
