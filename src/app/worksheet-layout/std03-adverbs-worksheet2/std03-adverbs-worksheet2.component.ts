...
@Component({
  selector: 'app-std03-adverbs-worksheet2',
  templateUrl: './std03-adverbs-worksheet2.component.html',
  styleUrls: ['./std03-adverbs-worksheet2.component.scss']
})
export class Std03AdverbsWorksheet2Component implements OnInit {
        ...
        $('.button').click(function () {
            if ($(this).hasClass('playAgain')) {
                ...
                if ($('.underlined').length >= 5) {
                    var Correct_Answers = ["upwards", "quietly", "Finally", "regularly", "smoothly", "easily", "soon", "Sometimes", "towards", "fast"];
