...
@Component({
  selector: 'app-std03-homophones-worksheet7',
  templateUrl: './std03-homophones-worksheet7.component.html',
  styleUrls: ['./std03-homophones-worksheet7.component.scss']
})
export class Std03HomophonesWorksheet7Component implements OnInit {
