...
@Component({
  selector: 'app-std01-synonyms-worksheet4',
  templateUrl: './std01-synonyms-worksheet4.component.html',
  styleUrls: ['./std01-synonyms-worksheet4.component.scss']
})
export class Std01SynonymsWorksheet4Component implements OnInit {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
          globalThis.commonWorksheet.reloadComponent();
            ...
            if (inputCount >= 3) {
                $('input').removeClass('bd');
                var Correct_Answers = ["frightened", "garbage", "cab", "toss", "dish", "battle"];
