...
@Component({
  selector: 'app-std03-conjunctions-worksheet1',
  templateUrl: './std03-conjunctions-worksheet1.component.html',
  styleUrls: ['./std03-conjunctions-worksheet1.component.scss']
})
export class Std03ConjunctionsWorksheet1Component implements OnInit {
