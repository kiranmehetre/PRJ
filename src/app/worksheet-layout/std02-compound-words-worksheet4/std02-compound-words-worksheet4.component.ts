...
@Component({
  selector: 'app-std02-compound-words-worksheet4',
  templateUrl: './std02-compound-words-worksheet4.component.html',
  styleUrls: ['./std02-compound-words-worksheet4.component.scss']
})
export class Std02CompoundWordsWorksheet4Component implements OnInit {
...
$(document).ready(function(){
  ...
  $('.button').click(function(){
    if($(this).hasClass('playAgain')){
      ...
      if(inputCount >= 4){
        $(inputs).removeClass('bd');
        var Correct_Answers=["port","mate","green","fire","no","motor","rattle","sun"];
