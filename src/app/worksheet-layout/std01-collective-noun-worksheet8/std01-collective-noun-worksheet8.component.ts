...
@Component({
  selector: 'app-std01-collective-noun-worksheet8',
  templateUrl: './std01-collective-noun-worksheet8.component.html',
  styleUrls: ['./std01-collective-noun-worksheet8.component.scss']
})
export class Std01CollectiveNounWorksheet8Component implements OnInit {
  ...
  ngOnInit() {
    ...
    $('.button').click(function () {
      ...
      if ($('.button').hasClass('playAgain')) {
        ...
        if (inputCount >= 5) {
          $(inputs).removeClass('bd');
          var Correct_Answers = ["suit", "herd", "staff", "shoal", "army", "herd", "pack", "flock", "bunch", "fleet"];
