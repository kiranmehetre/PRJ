...
@Component({
  ...
  templateUrl: './std03-articles-worksheet7.component.html',
  styleUrls: ['./std03-articles-worksheet7.component.scss']
})
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 5) {
            $(inputs).removeClass('bd');
            var Correct_Answers = [["an"], ["the"], ["a"], ["an"], ["the"], ["an"], ["a"], ["the", "a"], ["a"], ["an"]];
