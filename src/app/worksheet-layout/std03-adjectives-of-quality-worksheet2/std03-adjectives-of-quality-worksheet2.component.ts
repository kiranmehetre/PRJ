...
@Component({
  ...
  templateUrl: './std03-adjectives-of-quality-worksheet2.component.html',
  styleUrls: ['./std03-adjectives-of-quality-worksheet2.component.scss']
})
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 5) {
            $(inputs).parent().removeClass('bd');
            var Correct_Answers = ["sparkling", "mysterious", "hollow", "nutritious", "unique", "melodious", "slippery", "modern", "fragile", "powerful"];
