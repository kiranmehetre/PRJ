...
@Component({
  selector: 'app-std03-rhyming-words-worksheet9',
  templateUrl: './std03-rhyming-words-worksheet9.component.html',
  styleUrls: ['./std03-rhyming-words-worksheet9.component.scss']
})
export class Std03RhymingWordsWorksheet9Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 3) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["see", "tell", "wings", "asleep", "along", "food"];
