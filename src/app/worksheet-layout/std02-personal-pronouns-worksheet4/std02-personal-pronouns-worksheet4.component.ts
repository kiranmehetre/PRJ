...
@Component({
  selector: 'app-std02-personal-pronouns-worksheet4',
  templateUrl: './std02-personal-pronouns-worksheet4.component.html',
  styleUrls: ['./std02-personal-pronouns-worksheet4.component.scss']
})
export class Std02PersonalPronounsWorksheet4Component implements OnInit {
  ...
  ngOnInit() {
    ...
    var inputField;
    var inputValue, inputDataText, optionDataText;
    var ClickAnswer = [];
    var HelpBox = [];
    var Text = "";
    ...
    $('.button').click(function () {
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
          $(inputs).parent().removeClass('bd');
          var Correct_Answers = ["It", "They", "She", "We", "He", "It", "They", "We"];
