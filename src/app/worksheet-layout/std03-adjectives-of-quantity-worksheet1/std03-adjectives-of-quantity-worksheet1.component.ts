...
@Component({
  selector: 'app-std03-adjectives-of-quantity-worksheet1',
  templateUrl: './std03-adjectives-of-quantity-worksheet1.component.html',
  styleUrls: ['./std03-adjectives-of-quantity-worksheet1.component.scss']
})
export class Std03AdjectivesOfQuantityWorksheet1Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    var Correct_Answer = ['some', 'several', 'little', 'sufficient', 'any', 'much', 'enough', 'great', 'few', 'whole'];
    var i = 0;
