...
@Component({
  selector: 'app-std03-synonyms-worksheet9',
  templateUrl: './std03-synonyms-worksheet9.component.html',
  styleUrls: ['./std03-synonyms-worksheet9.component.scss']
})
export class Std03SynonymsWorksheet9Component implements OnInit {
  ...
  ngOnInit() {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
            ...
            if (inputCount >= 5) {
                $('input').removeClass('bd');
                var Correct_Answers = ["chilly", "false", "damage", "jump", "baby", "lost", "street", "tired","talk","injured"];
