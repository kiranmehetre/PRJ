...
@Component({
  selector: 'app-std01-prepositions-worksheet9',
  templateUrl: './std01-prepositions-worksheet9.component.html',
  styleUrls: ['./std01-prepositions-worksheet9.component.scss']
})
export class Std01PrepositionsWorksheet9Component implements OnInit {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
          globalThis.commonWorksheet.reloadComponent();
            ...
            if (inputCount >= 3) {
                $('input').removeClass('bd');
                var Correct_Answers = ["on", "between", "beside", "next to", "above", "behind"];
