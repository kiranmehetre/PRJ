...
@Component({
  selector: 'app-std01-gender-nouns-worksheet9',
  templateUrl: './std01-gender-nouns-worksheet9.component.html',
  styleUrls: ['./std01-gender-nouns-worksheet9.component.scss']
})
export class Std01GenderNounsWorksheet9Component implements OnInit {
...
$(document).ready(function(){
  ...
  $('.button').click(function(){
                    ...
                    else
                    {
                        ...
                        if(inputCount >= 3){
                            $(inputs).removeClass('bd');
                            var Correct_Answers=["cock","bull","sow","gander","duck"];
