...
@Component({
  selector: 'app-std02-gender-nouns-worksheet3',
  templateUrl: './std02-gender-nouns-worksheet3.component.html',
  styleUrls: ['./std02-gender-nouns-worksheet3.component.scss']
})
export class Std02GenderNounsWorksheet3Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($(this).hasClass('playAgain')) {
          ...
          if (inputCount >= 4) {
            $(inputs).parent().removeClass('bd');
            var Correct_Answers = ["G", "A", "E", "B", "D", "H", "F", "C"];
