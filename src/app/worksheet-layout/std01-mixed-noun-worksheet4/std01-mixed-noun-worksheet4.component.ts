...
@Component({
  selector: 'app-std01-mixed-noun-worksheet4',
  templateUrl: './std01-mixed-noun-worksheet4.component.html',
  styleUrls: ['./std01-mixed-noun-worksheet4.component.scss']
})
export class Std01MixedNounWorksheet4Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 6) {
            $(inputs).removeClass('bd');
            var Proper_Nouns_Inputs = $('.Answer:nth-child(1) input');
            var Common_Nouns_Inputs = $('.Answer:nth-child(2) input');
            var inputArray = [Proper_Nouns_Inputs, Common_Nouns_Inputs];
            var Correct_Answers = [];
            Correct_Answers[0] = ["Jack", "Anna", "Jenna", "The Statue of Liberty", "New York City", "Enid Blyton"];
            Correct_Answers[1] = ["sandwiches", "homework", "cousins", "holidays", "books", "dress"];
