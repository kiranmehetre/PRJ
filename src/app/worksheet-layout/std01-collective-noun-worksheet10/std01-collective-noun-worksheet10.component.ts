...
@Component({
  selector: 'app-std01-collective-noun-worksheet10',
  templateUrl: './std01-collective-noun-worksheet10.component.html',
  styleUrls: ['./std01-collective-noun-worksheet10.component.scss']
})
export class Std01CollectiveNounWorksheet10Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
          $('input').parent().removeClass('bd');
          var Correct_Answers = ["crowd", "string", "pack", "team", "bunch", "pile", "album", "choir"];
