...
@Component({
  selector: 'app-std02-apostrophe-worksheet2',
  templateUrl: './std02-apostrophe-worksheet2.component.html',
  styleUrls: ['./std02-apostrophe-worksheet2.component.scss']
})
export class Std02ApostropheWorksheet2Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($(this).hasClass('playAgain')) {
          ...
          if (inputCount >= 5) {
            $(inputs).parent().removeClass('bd');
            var Correct_Answers = ["E", "H", "J", "A", "I", "C", "F", "D", "B", "G"];
