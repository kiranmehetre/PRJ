...
@Component({
  selector: 'app-std03-articles-worksheet3',
  templateUrl: './std03-articles-worksheet3.component.html',
  styleUrls: ['./std03-articles-worksheet3.component.scss']
})
export class Std03ArticlesWorksheet3Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 4) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["an", "the", "X", "a", "an", "X", "the", "a"];
