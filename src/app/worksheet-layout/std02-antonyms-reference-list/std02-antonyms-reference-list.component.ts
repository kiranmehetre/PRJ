...
@Component({
  selector: 'app-std02-antonyms-reference-list',
  templateUrl: './std02-antonyms-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std02-antonyms-reference-list.component.scss']
})
export class Std02AntonymsReferenceListComponent implements OnInit {
