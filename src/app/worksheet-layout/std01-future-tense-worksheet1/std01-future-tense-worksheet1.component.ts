...
@Component({
  selector: 'app-std01-future-tense-worksheet1',
  templateUrl: './std01-future-tense-worksheet1.component.html',
  styleUrls: ['./std01-future-tense-worksheet1.component.scss']
})
export class Std01FutureTenseWorksheet1Component implements OnInit {
