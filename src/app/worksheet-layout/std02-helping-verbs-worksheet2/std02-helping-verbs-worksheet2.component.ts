...
@Component({
  selector: 'app-std02-helping-verbs-worksheet2',
  templateUrl: './std02-helping-verbs-worksheet2.component.html',
  styleUrls: ['./std02-helping-verbs-worksheet2.component.scss']
})
export class Std02HelpingVerbsWorksheet2Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 6) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["have", "was", "is", "are", "does", "did", "may", "am", "were", "had", "has", "do"];
