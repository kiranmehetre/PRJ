...
@Component({
  selector: 'app-std01-personal-pronouns-worksheet3',
  templateUrl: './std01-personal-pronouns-worksheet3.component.html',
  styleUrls: ['./std01-personal-pronouns-worksheet3.component.scss']
})
export class Std01PersonalPronounsWorksheet3Component implements OnInit {
