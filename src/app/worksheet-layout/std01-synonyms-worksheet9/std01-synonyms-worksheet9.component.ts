...
@Component({
  selector: 'app-std01-synonyms-worksheet9',
  templateUrl: './std01-synonyms-worksheet9.component.html',
  styleUrls: ['./std01-synonyms-worksheet9.component.scss']
})
export class Std01SynonymsWorksheet9Component implements OnInit {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
          globalThis.commonWorksheet.reloadComponent();
            ...
            if (inputCount >= 4) {
                $('input').removeClass('bd');
                var Correct_Answers = ["big", "smart", "cool", "under", "cry", "begin","noisy","shut"];
