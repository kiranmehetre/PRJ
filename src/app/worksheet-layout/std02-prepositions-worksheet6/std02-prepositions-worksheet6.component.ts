...
@Component({
  selector: 'app-std02-prepositions-worksheet6',
  templateUrl: './std02-prepositions-worksheet6.component.html',
  styleUrls: ['./std02-prepositions-worksheet6.component.scss']
})
export class Std02PrepositionsWorksheet6Component implements OnInit {
    ...
    $(document).ready(function(){
      ...
      $('.button').click(function(){
        ...
        else
        {
          ...
          if(inputCount >= 3){
            $(inputs).removeClass('bd');
            var Correct_Answers=["under","over","between","across","above","against"];
