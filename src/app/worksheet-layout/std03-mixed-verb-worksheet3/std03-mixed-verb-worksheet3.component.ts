...
@Component({
  selector: 'app-std03-mixed-verb-worksheet3',
  templateUrl: './std03-mixed-verb-worksheet3.component.html',
  styleUrls: ['./std03-mixed-verb-worksheet3.component.scss']
})
export class Std03MixedVerbWorksheet3Component implements OnInit {
  ...
  ngOnInit() {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
            ...
            if (inputCount >= 5) {
                $('input').removeClass('bd');
                var Correct_Answers = ["will", "learning", "barks", "should", "instructed", "shall", "did", "burning","drank","are"];
