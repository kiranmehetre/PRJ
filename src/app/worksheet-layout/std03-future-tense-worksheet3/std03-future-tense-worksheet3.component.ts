...
@Component({
  selector: 'app-std03-future-tense-worksheet3',
  templateUrl: './std03-future-tense-worksheet3.component.html',
  styleUrls: ['./std03-future-tense-worksheet3.component.scss']
})
export class Std03FutureTenseWorksheet3Component implements OnInit {
