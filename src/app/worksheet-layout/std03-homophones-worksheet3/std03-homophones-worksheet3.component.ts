...
@Component({
  selector: 'app-std03-homophones-worksheet3',
  templateUrl: './std03-homophones-worksheet3.component.html',
  styleUrls: ['./std03-homophones-worksheet3.component.scss']
})
export class Std03HomophonesWorksheet3Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 5) {
            $(inputs).parent().removeClass('bd');
            var Correct_Answers = ["G", "D", "J", "A", "I", "C", "F", "B", "H", "E"];
