...
@Component({
  selector: 'app-std01-interrogative-pronouns-worksheet3',
  templateUrl: './std01-interrogative-pronouns-worksheet3.component.html',
  styleUrls: ['./std01-interrogative-pronouns-worksheet3.component.scss']
})
export class Std01InterrogativePronounsWorksheet3Component implements OnInit {
    ...
    else
    {
      var inputCount=$('input[type="text"]').filter(function () {
        ...
        if(inputCount >= 4){
          ...
          var Correct_Answers=["Where","Why","Who","How","When","Which","What","Whose"];
          $(inputs).each(function(i){
            if($.trim($(this).val().toString()) !== Correct_Answers[i]){
              $(this).css({'color':'#ed1a1a','border-color':'#000'});
              $(this).siblings('.correct-ans').css('display','block');
            }
            else{
