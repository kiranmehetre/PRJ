...
@Component({
  selector: 'app-std02-prepositions-worksheet5',
  templateUrl: './std02-prepositions-worksheet5.component.html',
  styleUrls: ['./std02-prepositions-worksheet5.component.scss']
})
export class Std02PrepositionsWorksheet5Component implements OnInit {
    ...
    var inputField;
			...
			else
			{
				...
				if(inputCount >= 3){
					...
					var Correct_Answers=["under","across","on","at","over","in"];
