...
@Component({
  selector: 'app-std01-helping-verbs-worksheet5',
  templateUrl: './std01-helping-verbs-worksheet5.component.html',
  styleUrls: ['./std01-helping-verbs-worksheet5.component.scss']
})
export class Std01HelpingVerbsWorksheet5Component implements OnInit {
    ...
    $(document).ready(function(){
      ...
      $('.button').click(function(){
        ...
        else
        {
          ...
          if(inputCount >= 6){
            $(inputs).removeClass('bd');
            var Correct_Answers=["has","have","has","has","have","has","have","has","have","have","have","has"];
