...
@Component({
  selector: 'app-std02-possessive-pronouns-worksheet1',
  templateUrl: './std02-possessive-pronouns-worksheet1.component.html',
  styleUrls: ['./std02-possessive-pronouns-worksheet1.component.scss']
})
export class Std02PossessivePronounsWorksheet1Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 4) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["5", "1", "7", "3", "2", "4", "6"];
