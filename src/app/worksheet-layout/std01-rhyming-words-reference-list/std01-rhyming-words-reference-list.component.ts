...
@Component({
  selector: 'app-std01-rhyming-words-reference-list',
  templateUrl: './std01-rhyming-words-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std01-rhyming-words-reference-list.component.scss']
})
export class Std01RhymingWordsReferenceListComponent implements OnInit {
