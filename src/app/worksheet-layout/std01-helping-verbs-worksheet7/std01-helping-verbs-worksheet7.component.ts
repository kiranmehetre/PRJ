...
@Component({
  selector: 'app-std01-helping-verbs-worksheet7',
  templateUrl: './std01-helping-verbs-worksheet7.component.html',
  styleUrls: ['./std01-helping-verbs-worksheet7.component.scss']
})
export class Std01HelpingVerbsWorksheet7Component implements OnInit {
