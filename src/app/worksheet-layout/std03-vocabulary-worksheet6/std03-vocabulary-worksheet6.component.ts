...
@Component({
  selector: 'app-std03-vocabulary-worksheet6',
  templateUrl: './std03-vocabulary-worksheet6.component.html',
  styleUrls: ['./std03-vocabulary-worksheet6.component.scss']
})
export class Std03VocabularyWorksheet6Component implements OnInit {
