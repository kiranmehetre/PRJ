...
@Component({
  selector: 'app-std03-collective-noun-worksheet9',
  templateUrl: './std03-collective-noun-worksheet9.component.html',
  styleUrls: ['./std03-collective-noun-worksheet9.component.scss']
})
export class Std03CollectiveNounWorksheet9Component implements OnInit {
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 5) {
          ...
          var Correct_Answers = ["pack", "herd", "bunch", "fleet", "troop", "flock", "quiver", "panel", "attack", "album"];
