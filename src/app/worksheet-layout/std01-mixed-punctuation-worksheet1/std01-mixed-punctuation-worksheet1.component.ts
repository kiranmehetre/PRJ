...
@Component({
  selector: 'app-std01-mixed-punctuation-worksheet1',
  templateUrl: './std01-mixed-punctuation-worksheet1.component.html',
  styleUrls: ['./std01-mixed-punctuation-worksheet1.component.scss']
})
export class Std01MixedPunctuationWorksheet1Component implements OnInit {
