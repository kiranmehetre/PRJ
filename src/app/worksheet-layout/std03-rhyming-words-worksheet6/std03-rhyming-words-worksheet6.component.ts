...
@Component({
  selector: 'app-std03-rhyming-words-worksheet6',
  templateUrl: './std03-rhyming-words-worksheet6.component.html',
  styleUrls: ['./std03-rhyming-words-worksheet6.component.scss']
})
export class Std03RhymingWordsWorksheet6Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.myButton').click(function () {
        ...
        if ($('.myButton').hasClass('playAgain')) {
          ...
          if (inputCount >= 8) {
            var Correct_Answers = [["blouse", "mouse"], ["cheap", "sweep"], ["above", "shove"], ["staff", "graph"], ["drench", "wrench"], ["grass", "pass"], ["smart", "chart"], ["think", "shrink"]];
