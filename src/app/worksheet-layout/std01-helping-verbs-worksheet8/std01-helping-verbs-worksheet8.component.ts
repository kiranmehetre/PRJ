...
@Component({
  selector: 'app-std01-helping-verbs-worksheet8',
  templateUrl: './std01-helping-verbs-worksheet8.component.html',
  styleUrls: ['./std01-helping-verbs-worksheet8.component.scss']
})
export class Std01HelpingVerbsWorksheet8Component implements OnInit {
  ...
  ngOnInit() {
    ...
    $('input').click(function(){
        ...
        $(inputField).val('');
        $(this).closest('.question').find('.helpbox').removeClass('click');
    ...
    if(inputField !== undefined)
    {
      ...
      if(click_question_number===question_number_check)
      {
        ...
        $(this).closest('.helpbox-container').find('.helpbox').removeClass('click');
        $(this).addClass('click');
      }
    }
    });
    ...
    else
    {
      ...
      if(inputCount >= 4){
        ...
        var Correct_Answers=["has","has","have","has","has","have","have","has"];
        ...
        $('.click.wrong').addClass('wrong-click');
