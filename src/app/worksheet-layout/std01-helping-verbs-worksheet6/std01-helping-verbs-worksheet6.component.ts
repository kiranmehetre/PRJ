...
@Component({
  selector: 'app-std01-helping-verbs-worksheet6',
  templateUrl: './std01-helping-verbs-worksheet6.component.html',
  styleUrls: ['./std01-helping-verbs-worksheet6.component.scss']
})
export class Std01HelpingVerbsWorksheet6Component implements OnInit {
    ...
    $(document).ready(function(){
      ...
      $('.button').click(function(){
        ...
        else
        {
          ...
          if(inputCount >= 5){
            $(inputs).removeClass('bd');
            var Correct_Answers=["does","do","does","do","does","do","do","do","does","does"];
