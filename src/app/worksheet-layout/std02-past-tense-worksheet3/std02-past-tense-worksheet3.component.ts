...
@Component({
  selector: 'app-std02-past-tense-worksheet3',
  templateUrl: './std02-past-tense-worksheet3.component.html',
  styleUrls: ['./std02-past-tense-worksheet3.component.scss']
})
export class Std02PastTenseWorksheet3Component implements OnInit {
...
$('.button').click(function () {
    ...
    if ($('.button').hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
            $('input').removeClass('bd');
            var Correct_Answers = ["hit", "asked", "emptied", "watered", "spent", "opened", "carried", "worked"];
