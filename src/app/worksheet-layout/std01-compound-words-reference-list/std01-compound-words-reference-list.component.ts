...
@Component({
  selector: 'app-std01-compound-words-reference-list',
  templateUrl: './std01-compound-words-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std01-compound-words-reference-list.component.scss']
})
export class Std01CompoundWordsReferenceListComponent implements OnInit {
