...
@Component({
  selector: 'app-std01-mixed-verb-worksheet2',
  templateUrl: './std01-mixed-verb-worksheet2.component.html',
  styleUrls: ['./std01-mixed-verb-worksheet2.component.scss']
})
export class Std01MixedVerbWorksheet2Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    $('.button').click(function () {
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 8) {
          $(inputs).removeClass('bd');
          var Correct_Answers = ["can", "is", "was", "had", "are", "has", "were", "have", "ride", "buying", "chasing", "eaten", "practising", "lost", "thinking", "sold"];
