...
@Component({
  selector: 'app-std03-mixed-tense-worksheet3',
  templateUrl: './std03-mixed-tense-worksheet3.component.html',
  styleUrls: ['./std03-mixed-tense-worksheet3.component.scss']
})
export class Std03MixedTenseWorksheet3Component implements OnInit {
