...
@Component({
  selector: 'app-std03-comma-worksheet1',
  templateUrl: './std03-comma-worksheet1.component.html',
  styleUrls: ['./std03-comma-worksheet1.component.scss']
})
export class Std03CommaWorksheet1Component implements OnInit {

  constructor(private renderer: Renderer2,private commonWorksheet: CommonWorksheetService) {
    this.renderer.setStyle(document.body, 'background-color','#f5b517');
  }
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 7) {
          ...
          var percentage = (Correct_Answers_Count * 100) / 13;
          var DisplayResult = "";
          if (percentage > 80) {
          ...
          setTimeout(function () {
            $('.result').css('display', 'flex');
            $('.result .TextBox h1').text('Please solve at least 7 boxes before submitting');
          }, 500);
        }
      }
