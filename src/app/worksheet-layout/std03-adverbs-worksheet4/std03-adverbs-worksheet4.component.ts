...
@Component({
  selector: 'app-std03-adverbs-worksheet4',
  templateUrl: './std03-adverbs-worksheet4.component.html',
  styleUrls: ['./std03-adverbs-worksheet4.component.scss']
})
export class Std03AdverbsWorksheet4Component implements OnInit {
  ...
  ngOnInit() {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
            ...
            if (inputCount >= 4) {
                $(inputs).parent().removeClass('bd');
                var Correct_Answers = ["tonight", "just", "partially", "already", "often", "happily", "rarely", "politely"];
