...
@Component({
  selector: 'app-std02-possessive-pronouns-worksheet4',
  templateUrl: './std02-possessive-pronouns-worksheet4.component.html',
  styleUrls: ['./std02-possessive-pronouns-worksheet4.component.scss']
})
export class Std02PossessivePronounsWorksheet4Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($(this).hasClass('playAgain')) {
          ...
          if (inputCount >= 3) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["yours", "his", "ours", "theirs", "hers", "mine"];
