...
@Component({
  selector: 'app-std01-common-noun-worksheet1',
  templateUrl: './std01-common-noun-worksheet1.component.html',
  styleUrls: ['./std01-common-noun-worksheet1.component.scss']
})
export class Std01CommonNounWorksheet1Component implements OnInit {
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
          ...
          var Correct_Answers = ["train", "broom", "clock", "swing", "necklace", "vegetables", "tree", "bridge"];
