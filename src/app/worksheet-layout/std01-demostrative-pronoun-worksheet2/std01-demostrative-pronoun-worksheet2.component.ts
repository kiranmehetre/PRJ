...
@Component({
  selector: 'app-std01-demostrative-pronoun-worksheet2',
  templateUrl: './std01-demostrative-pronoun-worksheet2.component.html',
  styleUrls: ['./std01-demostrative-pronoun-worksheet2.component.scss']
})
export class Std01DemostrativePronounWorksheet2Component implements OnInit {
    ...
    $('.button').click(function () {
      ...
      if ($('.button').hasClass('playAgain')) {
        ...
        if (inputCount >= 3) {
          ...
          var Correct_Answers = ["This", "That", "This", "That", "That", "This"];
