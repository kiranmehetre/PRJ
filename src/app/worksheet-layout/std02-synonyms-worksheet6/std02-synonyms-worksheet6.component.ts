...
@Component({
  selector: 'app-std02-synonyms-worksheet6',
  templateUrl: './std02-synonyms-worksheet6.component.html',
  styleUrls: ['./std02-synonyms-worksheet6.component.scss']
})
export class Std02SynonymsWorksheet6Component implements OnInit {
        ...
        return false;
			...
			else
			{
				...
				if(inputCount >= 4){
					...
					var Correct_Answers=["grin","rush","push","seat","lost","unhappy","arrive","keep"];
