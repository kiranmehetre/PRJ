...
@Component({
  selector: 'app-std03-abstract-noun-worksheet4',
  templateUrl: './std03-abstract-noun-worksheet4.component.html',
  styleUrls: ['./std03-abstract-noun-worksheet4.component.scss']
})
export class Std03AbstractNounWorksheet4Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    var Correct_Answer = ['intelligence', 'amazement', 'silliness', 'pride', 'confidence', 'enthusiasm', 'sympathy', 'bravery', 'satisfaction', 'faith'];
    var i = 0;
