...
@Component({
  selector: 'app-std03-vocabulary-worksheet11',
  templateUrl: './std03-vocabulary-worksheet11.component.html',
  styleUrls: ['./std03-vocabulary-worksheet11.component.scss']
})
export class Std03VocabularyWorksheet11Component implements OnInit {
        ...
        if ($('.button').hasClass('playAgain')) {
          globalThis.commonWorksheet.reloadComponent();
            ...
            if (underlinedCount >= 8) {
                ...
                setTimeout(function () {
                    $('.result').css('display', 'flex');
                    $('.result .TextBox h1').text('Please colour at least 8 hexagons before submitting');
                }, 500);
            }
        }
