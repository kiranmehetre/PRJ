...
@Component({
  selector: 'app-std03-compound-words-reference-list',
  templateUrl: './std03-compound-words-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std03-compound-words-reference-list.component.scss']
})
export class Std03CompoundWordsReferenceListComponent implements OnInit {
