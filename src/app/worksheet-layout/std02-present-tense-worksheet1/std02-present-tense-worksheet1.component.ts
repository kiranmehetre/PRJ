...
@Component({
  selector: 'app-std02-present-tense-worksheet1',
  templateUrl: './std02-present-tense-worksheet1.component.html',
  styleUrls: ['./std02-present-tense-worksheet1.component.scss']
})
export class Std02PresentTenseWorksheet1Component implements OnInit {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if ($('.underlined').length >= 4) {
            var Correct_Answers = ["have", "are", "weighs", "is", "affect", "travel", "visits", "are"];
