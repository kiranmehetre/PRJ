...
@Component({
  selector: 'app-std03-gender-nouns-worksheet4',
  templateUrl: './std03-gender-nouns-worksheet4.component.html',
  styleUrls: ['./std03-gender-nouns-worksheet4.component.scss']
})
export class Std03GenderNounsWorksheet4Component implements OnInit {

   constructor(private renderer: Renderer2,private commonWorksheet: CommonWorksheetService) {
    this.renderer.setStyle(document.body, 'background-color','#4a4a4a');
  }
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 5) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["G", "J", "E", "I", "B", "D", "A", "F", "H", "C"];
