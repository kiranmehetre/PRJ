...
@Component({
  selector: 'app-std01-synonyms-reference-list',
  templateUrl: './std01-synonyms-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std01-synonyms-reference-list.component.scss']
})
export class Std01SynonymsReferenceListComponent implements OnInit {
