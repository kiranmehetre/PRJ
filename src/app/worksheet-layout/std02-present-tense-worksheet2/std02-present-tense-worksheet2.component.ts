...
@Component({
  selector: 'app-std02-present-tense-worksheet2',
  templateUrl: './std02-present-tense-worksheet2.component.html',
  styleUrls: ['./std02-present-tense-worksheet2.component.scss']
})
export class Std02PresentTenseWorksheet2Component implements OnInit {
    ...
    $('.button').click(function () {
      if ($('.button').hasClass('playAgain')) {
        ...
        if (underlinedCount >= 4) {
          ...
          $('.option span,.options > div').css('pointer-events', 'none');
          setTimeout(function () {
