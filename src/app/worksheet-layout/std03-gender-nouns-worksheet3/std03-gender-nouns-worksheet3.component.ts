...
@Component({
  selector: 'app-std03-gender-nouns-worksheet3',
  templateUrl: './std03-gender-nouns-worksheet3.component.html',
  styleUrls: ['./std03-gender-nouns-worksheet3.component.scss']
})
export class Std03GenderNounsWorksheet3Component implements OnInit {

   constructor(private renderer: Renderer2,private commonWorksheet: CommonWorksheetService) {
    this.renderer.setStyle(document.body, 'background-color','#f3eace');
  }
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 6) {
            ...
            var inputArray = [masculineInputs, feminineInputs];
            var Correct_Answers = [];
            Correct_Answers[0] = ["heir", "drone", "hart", "nephew", "drake", "instructor"];
            Correct_Answers[1] = ["priestess", "manageress", "heroine", "waitress", "fiancee", "spinster"];
