...
@Component({
  selector: 'app-std02-rhyming-words-reference-list',
  templateUrl: './std02-rhyming-words-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std02-rhyming-words-reference-list.component.scss']
})
export class Std02RhymingWordsReferenceListComponent implements OnInit {
