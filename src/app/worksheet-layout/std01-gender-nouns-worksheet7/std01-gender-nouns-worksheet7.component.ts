...
@Component({
  selector: 'app-std01-gender-nouns-worksheet7',
  templateUrl: './std01-gender-nouns-worksheet7.component.html',
  styleUrls: ['./std01-gender-nouns-worksheet7.component.scss']
})
export class Std01GenderNounsWorksheet7Component implements OnInit {
    ...
    $(document).ready(function(){
			...
			$('.button').click(function(){
				if($(this).hasClass('playAgain')){
					...
					if(inputCount >= 6){
						$(inputs).removeClass('bd');
						var Masculine_Gender_Inputs=$('.Masculine_Gender input');
                        var Feminine_Gender_Inputs=$('.Feminine_Gender input');
                        var Common_Gender_Inputs=$('.Common_Gender input');
                        var inputArray=[Masculine_Gender_Inputs,Feminine_Gender_Inputs,Common_Gender_Inputs];
                        var Correct_Answers=[];
                        Correct_Answers[0]=["sir","daddy","brother","shepherd"];
                        Correct_Answers[1]=["goddess","poetess","authoress","niece"];
                        Correct_Answers[2]=["cousin","baby","scientist","singer"];
