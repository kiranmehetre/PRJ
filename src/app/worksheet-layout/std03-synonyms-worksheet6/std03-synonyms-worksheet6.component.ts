...
@Component({
  selector: 'app-std03-synonyms-worksheet6',
  templateUrl: './std03-synonyms-worksheet6.component.html',
  styleUrls: ['./std03-synonyms-worksheet6.component.scss']
})
export class Std03SynonymsWorksheet6Component implements OnInit {
  ...
  ngOnInit() {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
            ...
            if (inputCount >= 5) {
                $('input').removeClass('bd');
                var Correct_Answers = ["tidy", "silent", "alike", "toss", "thief", "simple", "dish", "rude","answer","greedy"];
