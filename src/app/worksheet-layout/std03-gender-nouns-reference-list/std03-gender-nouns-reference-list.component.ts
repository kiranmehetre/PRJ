...
@Component({
  selector: 'app-std03-gender-nouns-reference-list',
  templateUrl: './std03-gender-nouns-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std03-gender-nouns-reference-list.component.scss']
})
export class Std03GenderNounsReferenceListComponent implements OnInit {
