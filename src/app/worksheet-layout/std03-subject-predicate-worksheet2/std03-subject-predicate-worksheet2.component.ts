...
@Component({
  selector: 'app-std03-subject-predicate-worksheet2',
  templateUrl: './std03-subject-predicate-worksheet2.component.html',
  styleUrls: ['./std03-subject-predicate-worksheet2.component.scss']
})
export class Std03SubjectPredicateWorksheet2Component implements OnInit {
