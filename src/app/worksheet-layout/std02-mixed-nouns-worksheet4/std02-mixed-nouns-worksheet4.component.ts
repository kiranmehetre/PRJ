...
@Component({
  selector: 'app-std02-mixed-nouns-worksheet4',
  templateUrl: './std02-mixed-nouns-worksheet4.component.html',
  styleUrls: ['./std02-mixed-nouns-worksheet4.component.scss']
})
export class Std02MixedNounsWorksheet4Component implements OnInit {
...
$(document).ready(function(){
  ...
  $('.button').click(function(){
    if($(this).hasClass('playAgain')){
      ...
      if(inputCount >= 6){
        $(inputs).removeClass('bd');
                    var Common_Nouns_Inputs=$('.Answer_Row .Answer:nth-child(1) input');
                    var Proper_Nouns_Inputs=$('.Answer_Row .Answer:nth-child(2) input');
                    var inputArray=[Common_Nouns_Inputs,Proper_Nouns_Inputs];
                    var Correct_Answers=[];
                    Correct_Answers[0]=["oven","fire","soil","egg","water","wind"];
                    Correct_Answers[1]=["South Africa","Eva","Mr. Lee","Ivan","The Great Wall","Dubai"];
