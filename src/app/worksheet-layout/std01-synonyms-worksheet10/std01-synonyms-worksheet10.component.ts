...
@Component({
  selector: 'app-std01-synonyms-worksheet10',
  templateUrl: './std01-synonyms-worksheet10.component.html',
  styleUrls: ['./std01-synonyms-worksheet10.component.scss']
})
export class Std01SynonymsWorksheet10Component implements OnInit {
...
$('.button').click(function () {
    ...
    if ($('.button').hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
            $('input').removeClass('bd');
            var Correct_Answers = ["story", "tiny", "mat", "like", "pretty", "fast","same","wet"];
