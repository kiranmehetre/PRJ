...
@Component({
  ...
  templateUrl: './std02-mixed-nouns-worksheet3.component.html',
  styleUrls: ['./std02-mixed-nouns-worksheet3.component.scss']
})
...
$('.helpbox-container td').each(function () {
...
$('.button').click(function () {
  ...
  if (inputCount >= 4) {
    ...
    var Correct_Answers = ["Italy", "Spiderman", "Channel Tunnel", "Jogger’s Park", "Greenfield Primary School", "Pizza Hut", "Great Mall", "Apollo Circus"];
    $(inputs).each(function (i) {
      if ($.trim($(this).val().toString()) !== Correct_Answers[i]) {
        $(this).css({ 'color': '#ed1a1a', 'border-color': '#000' });
        $(this).parent().next('.correct-answer').css('display', 'inline-block');
      }
      else {
