...
@Component({
  selector: 'app-std03-adjectives-of-quantity-worksheet2',
  templateUrl: './std03-adjectives-of-quantity-worksheet2.component.html',
  styleUrls: ['./std03-adjectives-of-quantity-worksheet2.component.scss']
})
export class Std03AdjectivesOfQuantityWorksheet2Component implements OnInit {

   constructor(private renderer: Renderer2,private commonWorksheet: CommonWorksheetService) {
    this.renderer.setStyle(document.body, 'background-color','#64a2b7');
  }
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 5) {
          ...
          var Correct_Answers = ["enough", "abundant", "little", "all", "sufficient", "any", "several", "some", "great", "most"];
