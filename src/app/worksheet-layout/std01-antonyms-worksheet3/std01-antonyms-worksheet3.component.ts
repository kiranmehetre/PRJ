...
@Component({
  selector: 'app-std01-antonyms-worksheet3',
  templateUrl: './std01-antonyms-worksheet3.component.html',
  styleUrls: ['./std01-antonyms-worksheet3.component.scss']
})
export class Std01AntonymsWorksheet3Component implements OnInit {
...
$('.button').click(function(){
          ...
          let inputCount=$('input').filter(function () {
            return !!$(this).val();
        }).length;

					if(inputCount >= 4){
						var Correct_answers=["full","rainy","sad","thin","sunset","young","straight","pull"];
