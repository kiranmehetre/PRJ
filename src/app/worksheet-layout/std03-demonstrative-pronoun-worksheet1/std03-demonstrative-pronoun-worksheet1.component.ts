...
@Component({
  selector: 'app-std03-demonstrative-pronoun-worksheet1',
  templateUrl: './std03-demonstrative-pronoun-worksheet1.component.html',
  styleUrls: ['./std03-demonstrative-pronoun-worksheet1.component.scss']
})
export class Std03DemonstrativePronounWorksheet1Component implements OnInit {
