...
@Component({
  selector: 'app-std03-compound-word-worksheet1',
  templateUrl: './std03-compound-word-worksheet1.component.html',
  styleUrls: ['./std03-compound-word-worksheet1.component.scss']
})
export class Std03CompoundWordWorksheet1Component implements OnInit {
