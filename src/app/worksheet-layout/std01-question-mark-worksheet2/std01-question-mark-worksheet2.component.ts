...
@Component({
  ...
  templateUrl: './std01-question-mark-worksheet2.component.html',
  styleUrls: ['./std01-question-mark-worksheet2.component.scss']
})
 ...
 this.commonWorksheet.reuseRoute();
    ...
    $(document).ready(function () {
      ...
      $(inputs).click(function () {
        ...
        $(inputField).closest('.text-container').find(".helpans").filter(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 4) {
            $(inputs).parent().removeClass('bd');
            var Correct_Answers = ["How", "Where", "What", "Who", "Why", "Whose", "When", "Which"];
