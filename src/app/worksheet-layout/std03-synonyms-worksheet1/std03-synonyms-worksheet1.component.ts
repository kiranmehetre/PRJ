...
@Component({
  selector: 'app-std03-synonyms-worksheet1',
  templateUrl: './std03-synonyms-worksheet1.component.html',
  styleUrls: ['./std03-synonyms-worksheet1.component.scss']
})
export class Std03SynonymsWorksheet1Component implements OnInit {
    ...
    $('.button').click(function () {
      if ($(this).hasClass('playAgain')) {
        ...
        if (underlinedCount >= 6) {
          ...
          setTimeout(function () {
            $('.result').css('display', 'flex');
            $('.result .TextBox h1').text('Please colour at least 6 apples before submitting');
          }, 500);
        }
      }
