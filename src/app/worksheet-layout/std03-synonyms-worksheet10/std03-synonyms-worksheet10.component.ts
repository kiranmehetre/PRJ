...
@Component({
  selector: 'app-std03-synonyms-worksheet10',
  templateUrl: './std03-synonyms-worksheet10.component.html',
  styleUrls: ['./std03-synonyms-worksheet10.component.scss']
})
export class Std03SynonymsWorksheet10Component implements OnInit {
    ...
    $('.helpbox-ans').each(function () {
        ...
        $('.button').click(function () {
            ...
            if ($('.button').hasClass('playAgain')) {
                ...
                if (inputCount >= 5) {
                    $('input').removeClass('bd');
                    var Correct_Answers = ["amusing", "noisy", "accomplish", "couch", "under", "live", "bunny", "tardy","cruel","uncommon"];
