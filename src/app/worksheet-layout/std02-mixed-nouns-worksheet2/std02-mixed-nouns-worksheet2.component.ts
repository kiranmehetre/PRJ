...
@Component({
  selector: 'app-std02-mixed-nouns-worksheet2',
  templateUrl: './std02-mixed-nouns-worksheet2.component.html',
  styleUrls: ['./std02-mixed-nouns-worksheet2.component.scss']
})
export class Std02MixedNounsWorksheet2Component implements OnInit {
...
$(document).ready(function(){
  ...
  $('.button').click(function(){
    if($(this).hasClass('playAgain')){
      ...
      if(inputCount >= 4){
        $(inputs).parent().removeClass('bd');
        var Correct_Answers=["8","4","6","1","7","2","5","3"];
