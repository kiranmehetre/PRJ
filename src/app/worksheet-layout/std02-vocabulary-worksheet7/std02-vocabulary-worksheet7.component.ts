...
@Component({
  selector: 'app-std02-vocabulary-worksheet7',
  templateUrl: './std02-vocabulary-worksheet7.component.html',
  styleUrls: ['./std02-vocabulary-worksheet7.component.scss']
})
export class Std02VocabularyWorksheet7Component implements OnInit {
    ...
    $('.helpbox-ans').each(function () {
        ...
        $('.button').click(function () {
            ...
            if ($('.button').hasClass('playAgain')) {
                ...
                if (inputCount >= 4) {
                    $('input').removeClass('bd');
                    var Correct_Answers = ["pea", "pear", "dog", "ring", "ear", "wolf","heart","face"];
