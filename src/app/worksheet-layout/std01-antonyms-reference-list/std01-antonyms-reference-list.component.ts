...
@Component({
  selector: 'app-std01-antonyms-reference-list',
  templateUrl: './std01-antonyms-reference-list.component.html',
  styles:['@import "http://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css";'],
  styleUrls: ['./std01-antonyms-reference-list.component.scss']
})
export class Std01AntonymsReferenceListComponent implements OnInit {
