...
@Component({
  selector: 'app-std03-helping-verbs-worksheet2',
  templateUrl: './std03-helping-verbs-worksheet2.component.html',
  styleUrls: ['./std03-helping-verbs-worksheet2.component.scss']
})
export class Std03HelpingVerbsWorksheet2Component implements OnInit {
    ...
    $(document).ready(function(){
        ...
        $('.button').click(function(){
            if($(this).hasClass('playAgain')){
                ...
                if(inputCount >= 5){
                    $(inputs).removeClass('bd');
                    var Correct_Answers=["has","have","has","have","have","was","were","was","were","was"];
