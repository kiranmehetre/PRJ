...
@Component({
  selector: 'app-std02-present-tense-worksheet3',
  templateUrl: './std02-present-tense-worksheet3.component.html',
  styleUrls: ['./std02-present-tense-worksheet3.component.scss']
})
export class Std02PresentTenseWorksheet3Component implements OnInit {
  ...
  ngOnInit() {
    ...
    $('.button').click(function () {
      ...
      if ($('.button').hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
          $('input').removeClass('bd');
          var Correct_Answers = ["sleep", "floats", "begins", "know", "lays", "flows", "wake", "swims"];
