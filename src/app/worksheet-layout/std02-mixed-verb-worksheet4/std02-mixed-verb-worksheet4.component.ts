...
@Component({
  selector: 'app-std02-mixed-verb-worksheet4',
  templateUrl: './std02-mixed-verb-worksheet4.component.html',
  styleUrls: ['./std02-mixed-verb-worksheet4.component.scss']
})
export class Std02MixedVerbWorksheet4Component implements OnInit {
...
$('.helpbox-ans').each(function () {
    ...
    $('.button').click(function () {
        ...
        if ($('.button').hasClass('playAgain')) {
            ...
            if (inputCount >= 4) {
                $('input').removeClass('bd');
                var Correct_Answers = ["are", "shopping", "shall", "chatting", "sung", "rushing","will","has"];
