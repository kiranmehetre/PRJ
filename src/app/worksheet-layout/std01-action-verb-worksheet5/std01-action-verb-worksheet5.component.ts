...
@Component({
  selector: 'app-std01-action-verb-worksheet5',
  templateUrl: './std01-action-verb-worksheet5.component.html',
  styleUrls: ['./std01-action-verb-worksheet5.component.scss']
})
export class Std01ActionVerbWorksheet5Component implements OnInit {
