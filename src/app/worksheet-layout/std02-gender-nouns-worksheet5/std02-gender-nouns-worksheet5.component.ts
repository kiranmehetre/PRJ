...
@Component({
  selector: 'app-std02-gender-nouns-worksheet5',
  templateUrl: './std02-gender-nouns-worksheet5.component.html',
  styleUrls: ['./std02-gender-nouns-worksheet5.component.scss']
})
export class Std02GenderNounsWorksheet5Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($('.button').hasClass('playAgain')) {
          ...
          if (inputCount >= 8) {
            $(inputs).removeClass('bd');
            var MasculineInputs = $('.Masculine input');
            var FeminineInputs = $('.Feminine input');
            var CommonInputs = $('.Common input');
            var inputArray = [MasculineInputs, FeminineInputs, CommonInputs];
            var Correct_Answers = [];
            Correct_Answers[0] = ["postman", "uncle", "host", "dog", "hero"];
            Correct_Answers[1] = ["aunt", "grandmother", "hostess", "witch", "princess"];
            Correct_Answers[2] = ["teachers", "children", "guests", "servant", "People"];
            ...
            $('input,u').css('pointer-events', 'none');
          }
          else {
            setTimeout(function () {
              $('.result').css('display', 'flex');
