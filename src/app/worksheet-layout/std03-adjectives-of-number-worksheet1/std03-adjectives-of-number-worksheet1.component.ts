...
@Component({
  selector: 'app-std03-adjectives-of-number-worksheet1',
  templateUrl: './std03-adjectives-of-number-worksheet1.component.html',
  styleUrls: ['./std03-adjectives-of-number-worksheet1.component.scss']
})
export class Std03AdjectivesOfNumberWorksheet1Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    var Correct_Answer = ['four', 'twenty-four', 'first', 'ten', 'six', 'third', 'Some', 'enough', 'All', 'any'];
    var i = 0;
