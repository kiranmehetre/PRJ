...
@Component({
  selector: 'app-std01-articles-worksheet9',
  templateUrl: './std01-articles-worksheet9.component.html',
  styleUrls: ['./std01-articles-worksheet9.component.scss']
})
export class Std01ArticlesWorksheet9Component implements OnInit {
    ...
    $('.button').click(function () {
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
          ...
          var Correct_Answers = ["the", "an", "the", "a", "the", "a", "an", "a"];
