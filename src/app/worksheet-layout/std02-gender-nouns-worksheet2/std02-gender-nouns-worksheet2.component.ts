...
@Component({
  selector: 'app-std02-gender-nouns-worksheet2',
  templateUrl: './std02-gender-nouns-worksheet2.component.html',
  styleUrls: ['./std02-gender-nouns-worksheet2.component.scss']
})
export class Std02GenderNounsWorksheet2Component implements OnInit {
 ...
 this.commonWorksheet.reuseRoute();
    ...
    $('.button').click(function () {
      ...
      if ($(this).hasClass('playAgain')) {
        ...
        if (inputCount >= 4) {
          $('input').removeClass('bd');
          var Correct_Answers = ["heir", "count", "signor", "fiance", "duke", "instructor", "lad", "bachelor"];
