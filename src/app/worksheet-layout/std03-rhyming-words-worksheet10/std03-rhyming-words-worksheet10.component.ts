...
@Component({
  selector: 'app-std03-rhyming-words-worksheet10',
  templateUrl: './std03-rhyming-words-worksheet10.component.html',
  styleUrls: ['./std03-rhyming-words-worksheet10.component.scss']
})
export class Std03RhymingWordsWorksheet10Component implements OnInit {
    ...
    $(document).ready(function () {
      ...
      $('.button').click(function () {
        if ($(this).hasClass('playAgain')) {
          ...
          if (inputCount >= 5) {
            $(inputs).removeClass('bd');
            var Correct_Answers = ["fight", "begun", "go", "floor", "that", "one", "ice", "fight", "night", "room"];
