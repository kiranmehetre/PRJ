...
@Component({
  selector: 'app-std02-compound-words-worksheet9',
  templateUrl: './std02-compound-words-worksheet9.component.html',
  styleUrls: ['./std02-compound-words-worksheet9.component.scss']
})
export class Std02CompoundWordsWorksheet9Component implements OnInit {
  ...
  $('.button').click(function(){
    if($(this).hasClass('playAgain')){
      ...
      if($('.underlined').length >= 5){
        var Correct_Answers=["background","doorknob","lifeguard","password","storeroom","weekend","butterfly","shipwreck","popcorn","hairbrush"];
